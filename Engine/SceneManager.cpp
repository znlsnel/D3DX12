...
#pragma region Object
	{
		...
		}
		{
			...
			shared_ptr<Texture> texture = GET_SINGLE(Resources)->Load<Texture>(L"Bricks", L"..\\Resources\\Texture\\Bricks.jpg");
			shared_ptr<Texture> texture2 = GET_SINGLE(Resources)->Load<Texture>(L"Bricks_Normal", L"..\\Resources\\Texture\\Bricks_Normal.jpg");
			shared_ptr<Material> material = make_shared<Material>();
			material->SetShader(shader);
			material->SetTexture(0, texture);
