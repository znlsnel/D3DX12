...
#pragma region SkyBox
	{
		...
		}
		{
			...
			shared_ptr<Texture> texture = GET_SINGLE(Resources)->Load<Texture>(L"Sky01", L"..\\Resources\\Texture\\sky.jpg");
...
#pragma region Cube
	{
		...
		{
			shared_ptr<Shader> shader = GET_SINGLE(Resources)->
				Get<Shader>(L"Forward");
			shared_ptr<Texture> texture = GET_SINGLE(Resources)->
				Load<Texture>(L"Bricks", L"..\\Resources\\Texture\\Bricks.jpg");
			shared_ptr<Texture> texture2 = GET_SINGLE(Resources)->
				Load<Texture>(L"Bricks_Normal", L"..\\Resources\\Texture\\Bricks_Normal.jpg");
...
#pragma region UI_Test
	{
		...
		}
		{
			...
			shared_ptr<Texture> texture = GET_SINGLE(Resources)->Load<Texture>(L"Fur", L"..\\Resources\\Texture\\Fur.jpg");
			shared_ptr<Material> material = make_shared<Material>();
			material->SetShader(shader);
			material->SetTexture(0, texture);
			meshRenderer->SetMaterial(material);
